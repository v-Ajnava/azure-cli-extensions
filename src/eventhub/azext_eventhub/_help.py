...
helps['eventhubs'] = """
    type: group
    short-summary: Manage Azure Event Hubs namespace, eventhub, consumergroup and Geo Disaster Recovery configuration - Alias
...
helps['eventhubs georecovery-alias'] = """
    type: group
    short-summary: Manage Azure Event Hubs Geo Disaster Recovery configuration - Alias
...
helps['eventhubs namespace exists'] = """
    ...
    examples:
        - name: Create a new topic.
          text: az eventhubs namespace check_name_availability --name mynamespace
...
helps['eventhubs namespace authorizationrule create'] = """
    ...
    examples:
        - name: Creates Authorization rules
          text: az eventhubs namespace authorizationrule create --resource-group myresourcegroup --namespace-name mynamespace
...
helps['eventhubs namespace authorizationrule delete'] = """
    ...
    examples:
        - name: Deletes the AuthorizationRule of the namespace.
          text: az eventhubs namespace authorizationrule delete --resource-group myresourcegroup --namespace-name mynamespace
           --name myauthorule
...
helps['eventhubs eventhub authorizationrule create'] = """
    ...
    examples:
        - name: Creates Authorization rules
          text: az eventhubs eventhub authorizationrule create --resource-group myresourcegroup --namespace-name mynamespace
...
helps['eventhubs eventhub authorizationrule show'] = """
    ...
    examples:
        - name: shows the details of AuthorizationRule
          text: az eventhubs eventhub authorizationrule show --resource-group myresourcegroup --namespace-name mynamespace
